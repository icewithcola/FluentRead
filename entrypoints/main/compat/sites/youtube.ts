...
function selectYouTube(node: Element): SelectResult {
  // 检查是否应该跳过该节点
...
function replaceYouTube(node: HTMLElement, text: string): void {
...
export const youtube: CompatSite = {
  domain: 'youtube.com',
  select: selectYouTube,
  replace: replaceYouTube,
};
